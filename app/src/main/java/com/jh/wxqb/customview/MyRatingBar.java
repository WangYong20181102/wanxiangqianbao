...
/**
 * 自定义评分控件
 * starCount	dimension	设置总个数
 * starNum	dimension	默认选择个数
 * clickable	boolean	是否可点击
 * touchable	boolean	是否可拖动
 * halfstart	boolean	是否支持选择0.5
 * starEmpty	drawable	未选择图标
 * starHalf	drawable	选择0.5图标
 * starFill	drawable	选择图标
 * starImageHeight	dimension	图标的高度
 * starImageWidth	dimension	图标的宽度
 * starImagePadding	dimension	图标之间Padding
 */
...
public class MyRatingBar extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, com.jh.wxqb.R.styleable.RatingBar);
        starHalfDrawable = mTypedArray.getDrawable(com.jh.wxqb.R.styleable.RatingBar_starHalf);
        starEmptyDrawable = mTypedArray.getDrawable(com.jh.wxqb.R.styleable.RatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(com.jh.wxqb.R.styleable.RatingBar_starFill);
        starImageWidth = mTypedArray.getDimension(com.jh.wxqb.R.styleable.RatingBar_starImageWidth, 60);
        starImageHeight = mTypedArray.getDimension(com.jh.wxqb.R.styleable.RatingBar_starImageHeight, 120);
        starImagePadding = mTypedArray.getDimension(com.jh.wxqb.R.styleable.RatingBar_starImagePadding, 15);
        starCount = mTypedArray.getInteger(com.jh.wxqb.R.styleable.RatingBar_starCount, 5);
        starNum = mTypedArray.getInteger(com.jh.wxqb.R.styleable.RatingBar_starNum, 0);
        mClickable = mTypedArray.getBoolean(com.jh.wxqb.R.styleable.RatingBar_clickable, true);
        mTouchable = mTypedArray.getBoolean(com.jh.wxqb.R.styleable.RatingBar_touchable, false);
        halfstart = mTypedArray.getBoolean(com.jh.wxqb.R.styleable.RatingBar_halfstart, false);
            ...
            if (originalCount > actualCount) {
                if (halfstart) {
                   ...
                   /* if (originalCount - actualCount < 0.5) {
                    ...
                    } else*/ if (originalCount - actualCount > 0.5){
