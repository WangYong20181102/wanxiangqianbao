 ...
 * 重購資產
 */
public class RepurchaseAssetsFragment extends BaseFragment implements AssetsView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_repurchase_assets, container, false);
