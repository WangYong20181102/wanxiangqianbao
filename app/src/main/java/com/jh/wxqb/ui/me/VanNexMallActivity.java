 ...
 * VanNexMall
 */
public class VanNexMallActivity extends BaseActivity {
    @BindView(R.id.webView)
    WebView mWebView;
    //VanNexMallurl
    private String appUrl = ServerInterface.BASE_VAN_NEX_MALL + "/index/reg/download.html";
