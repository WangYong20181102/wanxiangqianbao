 ...
 * 资产--转出
 */
public class TurnOutActivity extends BaseActivity implements MessageView, AssetsView {
...
//        }
                ...
                if (MyApplication.getUserBean() != null) {
                    if (MyApplication.getUserBean().getIsHasTradePwd()) {
                        ...
                        CancelOrOkDialog cancelOrOkDialog=new CancelOrOkDialog(this,R.string.please_set_the_transaction_password_first){
                            ...
                            public void ok() {
                                super.ok();
                                Intent intent=new Intent(TurnOutActivity.this, UdpPwdActivity.class);
    ...
    public void withdrawMoneySuccess(BaseBean result) {
        ...
        dialog.setTitle(R.string.turn_out_to_be_successful);
    ...
    @Subscribe
    public void udpTurnOut(String udpTurnOut) {
        if (!isFinishing()) {
            if (udpTurnOut.equals("udpTurnOut")) {
                initView();
            }
        }
    }
...
//            String[] zhuanzhangs = address.split("zhuanzhang");
//            if (zhuanzhangs.length == 2) {
//                if (zhuanzhangs[0].length() == 42) {
//                    edTargetAddress.setText(zhuanzhangs[0]);
//                } else {
//                    Toasts.showShort("请扫描正确二维码");
//                }
//                edAmountOfMoney.setText(zhuanzhangs[1]);
//            } else if (zhuanzhangs.length == 1) {
//                if (zhuanzhangs[0].length() == 42) {
//                    edTargetAddress.setText(zhuanzhangs[0]);
//                } else {
//                    Toasts.showShort("请扫描正确二维码");
...
//            }
    ...
    public void onViewFailureString(int statue, String message) {
        ...
        dialog.setTitle(R.string.fail_to_turn_out);
