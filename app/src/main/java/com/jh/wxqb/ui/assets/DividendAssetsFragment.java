 ...
 * 買入資產
 */
public class DividendAssetsFragment extends BaseFragment implements AssetsView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_dividend_assets, container, false);
    ...
    @OnClick({R.id.tv_turn_out, R.id.tv_transfer_to})
    public void onViewClicked(View view) {
        Intent intent;
        switch (view.getId()) {
            case R.id.tv_turn_out:
                intent = new Intent(mContext, TurnOutActivity.class);
                startActivity(intent);
                break;
            case R.id.tv_transfer_to:
                intent = new Intent(mContext, TurnInActivity.class);
                startActivity(intent);
                break;
        }
    }
