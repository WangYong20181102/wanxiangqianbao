...
public class EnjoyAssetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<AssetManagementBean.DataBean.AccountAssetsBean> financialDetailsBeen;

    public EnjoyAssetAdapter(Context mContext, List<AssetManagementBean.DataBean.AccountAssetsBean> financialDetailsBeen) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_enjoy_assets, parent, false);
